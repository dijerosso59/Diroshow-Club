...
/* blog/blog.html.twig */
class __TwigTemplate_e0c52cec8c4600d7c1a4829d649dd90c extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<h2 class=\"text-white mt-7 text-lg font-semibold md:text-xl xl:text-2xl\">";
            ...
            echo "</h2>
\t\t\t\t\t\t\t<p class=\"font-normal text-gray-500 text-base mt-5 text-right\">";
            // line 20
            echo twig_escape_filter($this->env, $this->extensions['Twig\Extra\Intl\IntlExtension']->formatDateTime($this->env, twig_get_attribute($this->env, $this->source, $context["article"], "date", [], "any", false, false, false, 20), "medium", "medium", "EEEE dd MMMM YYYY", null, "gregorian", "fr"), "html", null, true);
            echo "</p>
\t\t\t\t\t\t</article>
\t\t\t\t\t</a>
\t\t\t\t</li>
