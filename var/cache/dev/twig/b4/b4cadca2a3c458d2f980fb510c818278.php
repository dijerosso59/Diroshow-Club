...
/* Blog/blog.html.twig */
class __TwigTemplate_3a70ed7726a0c019219b3620197f3b7b extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<li>
\t\t\t\t\t<article>
\t\t\t\t\t\t<img src=\"http://placehold.it/200x200\" alt=\"image article\">
\t\t\t\t\t\t<h2 class=\"text-blue-500\">How to design a product that can grow itself 10x in year</h2>
\t\t\t\t\t</article>
\t\t\t\t</li>
\t\t\t</ul>
\t\t\t<div>
